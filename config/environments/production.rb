NSCatalog::Application.configure do
  ...
  config.assets.precompile += %w( prototype.js application.js manager.js manager.css print.css ie.css pdf.css sds.js sds.css admin.js admin.css sds_admin.js sds_admin.css )
